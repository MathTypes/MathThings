...
<a href="#begen">links</a>
        <h3>Division</h3>
    <h4 class="History"id="Divide"><p>There have been many ways of designating division and we are going to explain the origin of some of the symbols most used and best known by all.<br>
...
<a class="History"href="#begen">links</a>
    <h3>Algebra</h3>
...
<a href="#begen">links</a>
    <h3>Geometry</h3>
    <h4 class="History"id="Geometry"><p>Geometry's origins go back to approximately 3,000 BC in ancient Egypt. Ancient Egyptians used an early stage of geometry in several ways, including the surveying of land, construction of pyramids, and astronomy. Around 2,900 BC, ancient Egyptians began using their knowledge to construct pyramids with four triangular faces and a square base.
...
<a href="#begen">links</a>
    <h3>Calculus</h3>
    <h4 class="History"id="Calculus"><p>Modern calculus was developed in 17th-century Europe by Isaac Newton and Gottfried Wilhelm Leibniz (independently of each other, first publishing around the same time) but elements of it appeared in ancient Greece, then in China and the Middle East, and still later again in medieval Europe and in India.
